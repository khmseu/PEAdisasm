...
class TestRegionInterpretation(unittest.TestCase):
    def test_data_text_regions_override_decode_fallback(self) -> None:
        ...
        self.assertEqual(
            resolve_region_kind(0x2000, directives, fallback_kind="CODE"), "DATA"
        )
        self.assertEqual(
            resolve_region_kind(0x2001, directives, fallback_kind="CODE"), "TEXT"
        )
        self.assertEqual(
            resolve_region_kind(0x2002, directives, fallback_kind="CODE"), "SW16"
        )
        self.assertEqual(
            resolve_region_kind(0x2003, directives, fallback_kind="DATA"), "CODE"
        )
        self.assertEqual(
            resolve_region_kind(0x2004, directives, fallback_kind="CODE"), "CODE"
        )
    ...
    def test_explicit_precedence_with_overlap(self) -> None:
        ...
        self.assertEqual(
            resolve_region_kind(0x3000, directives, fallback_kind="CODE"), "TEXT"
        )
    ...
    def test_inclusive_boundaries(self) -> None:
        ...
        self.assertEqual(
            resolve_region_kind(0x4000, directives, fallback_kind="CODE"), "DATA"
        )
        self.assertEqual(
            resolve_region_kind(0x4002, directives, fallback_kind="CODE"), "DATA"
        )
        self.assertEqual(
            resolve_region_kind(0x4003, directives, fallback_kind="CODE"), "CODE"
        )
